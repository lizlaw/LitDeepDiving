...
- Concept is to utilize (full) citation records to cluster the literature
- 'Clustering' can utilize data from keywords, cited references, journals, and/or terms extracted from titles and abstracts, ...
- Characterise the clusters by keywords, "topic models"
...
- interactively select or exclude individual articles or words
